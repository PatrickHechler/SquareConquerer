...
public class SquareConquererCUI implements Runnable {
	...
	private static final Format READN_NUM_AND_THE_MAXIMUM_NUMBER_IS       = Messages.getFormat("SquareConquererCUI.read-num~max-num-addition"); //$NON-NLS-1$
	private static final Format READN_NUM_THE_MINIMUM_NUMBER_IS_0_1       = Messages.getFormat("SquareConquererCUI.read-num~min-num-is"); //$NON-NLS-1$
	private static final Format READN_NUM_COULD_NOT_PARSE_THE_NUMBER_0_1  = Messages.getFormat("SquareConquererCUI.read-num~invalid-number"); //$NON-NLS-1$
	private static final Format LOAD_TASK_LOAD_NOW_THE_FILE_0             = Messages.getFormat("SquareConquererCUI.load-task~load-file"); //$NON-NLS-1$
	...
	private static final Format ERROR_WHILE_EXECUTING_TASK_0              = Messages.getFormat("SquareConquererCUI.error-while-exec-task"); //$NON-NLS-1$
	// help constants
	...
	private static final Format HELP_GENERAL_MESSAGE = Messages.getFormat("SquareConquererCUI.help~general-help"); //$NON-NLS-1$
	// version constants
	private static final Format VERSION_HELP_0_BLA_BLA             = Messages.getFormat("SquareConquererCUI.version~help"); //$NON-NLS-1$
	private static final Format VERSION_SQUARE_CONQUERER_VERSION_0 = Messages.getFormat("SquareConquererCUI.version~version"); //$NON-NLS-1$
	// status constants
	private static final Format STATUS_USER_NAME_0                       = Messages.getFormat("SquareConquererCUI.status~user-name"); //$NON-NLS-1$
	private static final Format STATUS_USER_NOT_LOGGED_IN_USERNAME_0     = Messages.getFormat("SquareConquererCUI.status~user-not-logged-in-name"); //$NON-NLS-1$
	private static final Format STATUS_BOUNDS_XLEN_0_YLEN_1              = Messages.getFormat("SquareConquererCUI.status~world-bounds"); //$NON-NLS-1$
	private static final Format STATUS_WORLD_UNKNOWN_TYPE_0              = Messages.getFormat("SquareConquererCUI.status~unknown-world-type"); //$NON-NLS-1$
	...
	private static final Format STATUS_SERVER_RUNNING                    = Messages.getFormat("SquareConquererCUI.status~server-n-connects"); //$NON-NLS-1$
	...
	private static final Format STATUS_HELP_BLA_BLA                      = Messages.getFormat("SquareConquererCUI.status~help"); //$NON-NLS-1$
	...
	private static final Format USERNAME_CURRENT_USERNAME                = Messages.getFormat("SquareConquererCUI.username~your-current"); //$NON-NLS-1$
	private static final Format USERNAME_HELP_CMD_0_HELP_1_SET_2_GET_3   = Messages.getFormat("SquareConquererCUI.username~help"); //$NON-NLS-1$
	// world constants
	private static final Format WORLD_LOAD_THE_PATH_0_DOES_NOT_A_FILE        = Messages.getFormat("SquareConquererCUI.world~load~path-is-no-file"); //$NON-NLS-1$
	private static final Format WORLD_LOAD_THE_FILE_0_DOES_NOT_EXIST         = Messages.getFormat("SquareConquererCUI.world~load~path-not-exist"); //$NON-NLS-1$
	private static final Format WORLD_PRINT_GROUNDS_LEGEND                   = Messages.getFormat("SquareConquererCUI.world~print-ground~legend"); //$NON-NLS-1$
	private static final Format WORLD_PRINT_SIZES                            = Messages.getFormat("SquareConquererCUI.world~print-size"); //$NON-NLS-1$
	private static final Format WORLD_PRINT_RESOURCES_LEGEND                 = Messages.getFormat("SquareConquererCUI.world~print-resource~legend"); //$NON-NLS-1$
	...
	private static final Format WORLD_TILE_X_0_Y_1_GROUND_2_RESOURCE_3       = Messages.getFormat("SquareConquererCUI.world~print~single-tile"); //$NON-NLS-1$
	...
	private static final Format WORLD_TILE_RESOURCE_UNKNOWN_RESOURCE         = Messages.getFormat("SquareConquererCUI.world~unknown-resource-type"); //$NON-NLS-1$
	private static final Format WORLD_TILE_TYPE_UNKNOWN_GROUND               = Messages.getFormat("SquareConquererCUI.world~unknown-ground-type"); //$NON-NLS-1$
	private static final Format WORLD_TILE_TYPE_NOT_ACCEPT_SUFFIX            = Messages.getFormat("SquareConquererCUI.world~type-0-no-accepts-suffix-1"); //$NON-NLS-1$
	...
	private static final Format WORLD_BUILD_ERROR_ON_BUILD                   = Messages.getFormat("SquareConquererCUI.world~build-failed"); //$NON-NLS-1$
	...
	private static final Format WORLD_SAVE__ALL_ERROR_ON_SAVE                = Messages.getFormat("SquareConquererCUI.world~save~error-on-save"); //$NON-NLS-1$
	...
	private static final Format WORLD_CREATE_ERROR_CLOSING_REMOTE_WORLD      = Messages.getFormat("SquareConquererCUI.world~server~error-on-close"); //$NON-NLS-1$
	private static final Format WORLD_CREATE_COULD_NOT_PARSE_THE_WORLD_SIZE  = Messages.getFormat("SquareConquererCUI.world~create~unparsable-world-size"); //$NON-NLS-1$
	...
	private static final Format WORLD_LOAD_ERROR_ON_LOAD                     = Messages.getFormat("SquareConquererCUI.world~load~error-on-load"); //$NON-NLS-1$
	...
	private static final Format WORLD_HELP_BLA_BLA_MNY_ARGS                  = Messages.getFormat("SquareConquererCUI.world~help"); //$NON-NLS-1$
	// server constants
	...
	private static final Format SERVER_NOARG_ENTER_NOW_SERVER_PORT_DEFAULT_IS_0 = Messages.getFormat("SquareConquererCUI.server~enter-now-port"); //$NON-NLS-1$
	private static final Format SERVER_NOARG_ERROR_DURING_CONNECT               = Messages.getFormat("SquareConquererCUI.server~error-on-connect"); //$NON-NLS-1$
	private static final Format SERVER_NOARG_CONNECTED_TO_0_AT_PORT_1           = Messages.getFormat("SquareConquererCUI.server~connect~finish"); //$NON-NLS-1$
	...
	private static final Format SERVER_NOARG_C_ONNECT_0_OR_N_OTHING             = Messages.getFormat("SquareConquererCUI.server~c_onnect-or-n_othing"); //$NON-NLS-1$
	private static final Format SERVER_NOARG_NOT_LOGGED_IN                      = Messages.getFormat("SquareConquererCUI.server~no-user"); //$NON-NLS-1$
	private static final Format SERVER_NOARG_ERROR_WHILE_DISCONNECT_NO_RETRY_0  = Messages.getFormat("SquareConquererCUI.server~error-on-disconnect"); //$NON-NLS-1$
	...
	private static final Format SERVER_START_ERROR_AT_SERVER_THREAD_0           = Messages.getFormat("SquareConquererCUI.server~error-on-server-thread"); //$NON-NLS-1$
	private static final Format SERVER_START_USER_0_LOGGED_IN_FROM_1            = Messages.getFormat("SquareConquererCUI.server~notfy-user-log-in"); //$NON-NLS-1$
	private static final Format SERVER_USER_0_DISCONNECTED                      = Messages.getFormat("SquareConquererCUI.server~notfy-user-disconnect"); //$NON-NLS-1$
	...
	private static final Format SERVER_DISCONNECT_DISCONNECTING_ERROR_NO_RETRY  = Messages.getFormat("SquareConquererCUI.server~disconnect~error-on-disconnect"); //$NON-NLS-1$
	...
	private static final Format SERVER_CONNECT_ERROR_WHILE_CONNECTING_0         = Messages.getFormat("SquareConquererCUI.server~connect~error-on-connect"); //$NON-NLS-1$
	private static final Format SERVER_COULD_NOT_PARSE_PORT_0                   = Messages.getFormat("SquareConquererCUI.server~connect~unparsable-port"); //$NON-NLS-1$
	private static final Format SERVER_CONNECT_NOT_LOGGED_IN                    = Messages.getFormat("SquareConquererCUI.server~connect~no-user"); //$NON-NLS-1$
	...
	private static final Format SERVER_HELP_BLA_BLA                             = Messages.getFormat("SquareConquererCUI.server~help");                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               // set //$NON-NLS-1$
																																		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               // password
																																		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               // constants
	...
	private static final Format SET_PW_PW_OF_0_CHANGED                          = Messages.getFormat("SquareConquererCUI.ser-pw~usrs-pw-changed"); //$NON-NLS-1$
	...
	private static final Format SET_PW_USER_0_NOT_FOUND                         = Messages.getFormat("SquareConquererCUI.ser-pw~usr-not-found"); //$NON-NLS-1$
	private static final Format SET_PW_HELP_0_SET_OF_1_2_ME_3                   = Messages.getFormat("SquareConquererCUI.ser-pw~help"); //$NON-NLS-1$
	...
	private static final Format SET_PW_Y_OUR_PW_0_OR_DO_N_OTHING                = Messages.getFormat("SquareConquererCUI.ser-pw~set-y_our-pw-or-n_othing");                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                // server //$NON-NLS-1$
	// PW
	// constants
	...
	private static final Format SERVER_PW_HELP_BLA_BLA                        = Messages.getFormat("SquareConquererCUI.server-pw~help"); //$NON-NLS-1$
	private static final String SERVER_PW_R_EMOVE                             = Messages.getString("SquareConquererCUI.server-pw~r_emove-addition"); //$NON-NLS-1$
	private static final Format SERVER_PW_S_ET_0_THE_SERVER_PW_OR_DO_N_OTHING = Messages.getFormat("SquareConquererCUI.server-pw~s_et-server-pw-or-n_othing"); //$NON-NLS-1$
	// quit constants
	private static final Format QUIT_ERROR_WHILE_PARSING_EXIT_NUMBER_0 = Messages.getFormat("SquareConquererCUI.quit~unparsable-exit-num"); //$NON-NLS-1$
	private static final Format QUIT_HELP_BLA_BLA_HELP_WITH_0          = Messages.getFormat("SquareConquererCUI.quit~help"); //$NON-NLS-1$
	private static final Format QUIT_GOODBYE_EXIT_NOW_WITH_0           = Messages.getFormat("SquareConquererCUI.quit~bye"); //$NON-NLS-1$
	// general constants
	private static final Format UNKNOWN_GROUND_TYPE_0                             = Messages.getFormat("SquareConquererCUI.general~unknown-ground"); //$NON-NLS-1$
	private static final Format UNKNOWN_TILE_RESOURCE_0                           = Messages.getFormat("SquareConquererCUI.general~unknown-resource"); //$NON-NLS-1$
	private static final Format COORDINATE_IS_OUT_OF_BOUNDS_XLEN_0_YLEN_1_X_2_Y_3 = Messages.getFormat("SquareConquererCUI.general~coordinate-out-of-bounds"); //$NON-NLS-1$
	private static final Format INTERRUPT_ERROR_0                                 = Messages.getFormat("SquareConquererCUI.general~interrupted"); //$NON-NLS-1$
	private static final Format NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG                 = Messages.getFormat("SquareConquererCUI.general~no-enugh-args"); //$NON-NLS-1$
	private static final Format UNKNOWN_ARGUMENT_0                                = Messages.getFormat("SquareConquererCUI.general~unknow-arg"); //$NON-NLS-1$
	private static final Format ERROR_WHILE_EXECUTING_THE_COMMAND_0               = Messages.getFormat("SquareConquererCUI.general~error-on-exec"); //$NON-NLS-1$
	private static final Format UNKNOWN_COMMAND_0                                 = Messages.getFormat("SquareConquererCUI.general~unknown-command"); //$NON-NLS-1$
	private static final Format GREET_BLA_BLA_HELP_WITH_0_COMMAND                 = Messages.getFormat("SquareConquererCUI.greet"); //$NON-NLS-1$
	...
	public void run() {
		...
		while (true) {
			doTasks();
			if (greet) {
				this.c.writeLines(Messages.format(GREET_BLA_BLA_HELP_WITH_0_COMMAND, HELP));
				greet = false;
			}
	...
	private void exec(List<String> args) {
		try {
			...
			default -> this.c.writeLines(Messages.format(UNKNOWN_COMMAND_0, args.get(0)));
			}
		} catch (RuntimeException e) {
			this.c.writeLines(Messages.format(ERROR_WHILE_EXECUTING_THE_COMMAND_0, e));
		}
	}
	...
	private void cmdQuit(List<String> args) {
		if (args.size() == 1) {
			if (this.interactive) {
				this.c.writeLines(Messages.format(QUIT_GOODBYE_EXIT_NOW_WITH_0, "0")); //$NON-NLS-1$
			}
			System.exit(0);
		}
		for (int i = 1; i < args.size(); i++) {
			if (HELP.equalsIgnoreCase(args.get(i))) {
				this.c.writeLines(Messages.format(QUIT_HELP_BLA_BLA_HELP_WITH_0, HELP));
			} else {
				try {
					int e = Integer.parseInt(args.get(i));
					this.c.writeLines(Messages.format(QUIT_GOODBYE_EXIT_NOW_WITH_0, Integer.toString(e)));
					System.exit(e);
				} catch (NumberFormatException e) {
					this.c.writeLines(Messages.format(QUIT_ERROR_WHILE_PARSING_EXIT_NUMBER_0, e));
					this.c.writeLines(Messages.format(QUIT_GOODBYE_EXIT_NOW_WITH_0, "1")); //$NON-NLS-1$
					System.exit(1);
				}
			}
		}
	...
	private void cmdServerPW(List<String> args) {
		if (args.size() == 1) {
			switch (ask(Messages.format(SERVER_PW_S_ET_0_THE_SERVER_PW_OR_DO_N_OTHING, (this.serverPW != null ? SERVER_PW_R_EMOVE : "")), //$NON-NLS-1$
		...
		for (int i = 1; i < args.size(); i++) {
			...
			case HELP -> {
				this.c.writeLines(Messages.format(SERVER_PW_HELP_BLA_BLA, argStatus, argSet, argRemove, argRemoveNoFail));
			}
			case argStatus -> {
			...
			case argSet -> {
				if (++i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argSet));
					return;
				}
			...
			default -> this.c.writeLines(Messages.format(UNKNOWN_ARGUMENT_0, args.get(i)));
			}
		}
	}
	...
	private void cmdSetPW(List<String> args) {
		if (args.size() == 1) {
			switch (ask(Messages.format(SET_PW_Y_OUR_PW_0_OR_DO_N_OTHING, (this.usr instanceof RootUser ? SET_PW_S_OMEONES_PASSWORD : "")), //$NON-NLS-1$
			...
			case 's' -> {
				...
				if (user == null) {
					this.c.writeLines(Messages.format(SET_PW_USER_0_NOT_FOUND, name));
					return;
				}
				char[] npw = this.c.readPassword(SET_PW_PROMPT_ENTER_USER_PASSWORD);
				((RootUser) this.usr).changePW(user, npw);
				this.c.writeLines(Messages.format(SET_PW_PW_OF_0_CHANGED, name));
			}
			case 'n' -> {/**/}
		...
		for (int i = 1; i < args.size(); i++) {
			...
			switch (args.get(i).toLowerCase()) {
			case HELP -> {
				this.c.writeLines(Messages.format(SET_PW_HELP_0_SET_OF_1_2_ME_3, HELP, argSet, argOf, argMe, argSet, argOf, argMe));
			}
			case argSet, argOf -> {
				if (++i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argSet + "/" + argOf)); //$NON-NLS-1$
					return;
				}
				setPW(args.get(i));
			}
	...
	private void cmdServer(List<String> args) {
		...
		for (int i = 1; i < args.size(); i++) {
			...
			switch (args.get(i).toLowerCase()) {
			case HELP -> {
				this.c.writeLines(Messages.format(SERVER_HELP_BLA_BLA, argStatus, argConnect, argDisconnect, argStart, "" + Connection.DEFAULT_PORT, argStop)); //$NON-NLS-1$
			}
			case argStatus -> {
			...
			case argConnect -> {
				if (++i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argConnect));
					return;
				}
				if (this.usr == null) {
					this.c.writeLines(Messages.format(SERVER_CONNECT_NOT_LOGGED_IN, CMD_SETPW, CMD_USERNAME));
					return;
				}
				...
				if (li != -1 && li - 1 == addr.lastIndexOf(']') && addr.charAt(0) == '[') {
					try {
						...
						this.c.writeLines(Messages.format(SERVER_COULD_NOT_PARSE_PORT_0, e));
						return;
					}
				}
				try {
					...
					this.c.writeLines(Messages.format(SERVER_CONNECT_ERROR_WHILE_CONNECTING_0, e));
					return;
				}
			}
			case argDisconnect -> {
				...
				try {
					...
					this.c.writeLines(Messages.format(SERVER_DISCONNECT_DISCONNECTING_ERROR_NO_RETRY, e));
				}
			}
			case argStart -> {
				if (++i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argStart));
					return;
				}
				synchronized (this) {
					if (this.serverThread != null) {
						...
						this.serverThread = threadStart(() -> {
												try {
													Connection.ServerAccept.accept(port, rw, (conn, sok) -> {
																			if (sok == null) {
																				this.c.writeLines(Messages.format(SERVER_USER_0_DISCONNECTED, conn.usr.name()));
																			} else {
																				this.c.writeLines(Messages.format(SERVER_START_USER_0_LOGGED_IN_FROM_1,
																					conn.usr.name(), sok.getInetAddress()));
																			}
																		},
														cs, spw);
												} catch (IOException e) {
													this.c.writeLines(Messages.format(SERVER_START_ERROR_AT_SERVER_THREAD_0, e));
												} finally {
													synchronized (SquareConquererCUI.this) {
			...
			case argStop -> {
				...
				try {
					...
					this.c.writeLines(Messages.format(INTERRUPT_ERROR_0, e));
				}
				if (st.isAlive()) {
		...
		if (st != null) {
			...
			if (ask(SERVER_NOARG_PROMPT_D_ISCONNECT_OR_N_OTHING, "dn") == 'd') { //$NON-NLS-1$
				...
				try {
					...
					this.c.writeLines(Messages.format(SERVER_NOARG_ERROR_WHILE_DISCONNECT_NO_RETRY_0, e));
				}
				this.world = nw;
			}
		} else if (this.usr == null) {
			this.c.writeLines(Messages.format(SERVER_NOARG_NOT_LOGGED_IN, CMD_SETPW, CMD_USERNAME));
		} else {
			switch (ask(Messages.format(SERVER_NOARG_C_ONNECT_0_OR_N_OTHING, (this.world instanceof RootWorld ? SERVER_NOARG_S_TART_SERVER : "")), //$NON-NLS-1$
			...
			case 'c' -> {
				...
				try {
					...
					this.world = new RemoteWorld(conn);
					this.c.writeLines(Messages.format(SERVER_NOARG_CONNECTED_TO_0_AT_PORT_1, host, Integer.toString(port)));
				} catch (IOException e) {
					this.c.writeLines(Messages.format(SERVER_NOARG_ERROR_DURING_CONNECT, e));
				}
			}
			case 's' -> {
				RootWorld rw      = (RootWorld) this.world;
				String    portStr = this.c.readLine(Messages.format(SERVER_NOARG_ENTER_NOW_SERVER_PORT_DEFAULT_IS_0, "" + Connection.DEFAULT_PORT)).trim(); //$NON-NLS-1$
					...
					try {
						...
						Connection.ServerAccept.accept(port, rw, (conn, sok) -> {
							if (sok == null) {
								...
								this.c.writeLines(Messages.format(SERVER_START_USER_0_LOGGED_IN_FROM_1, conn.usr.name(), sok.getInetAddress()));
							}
						}, cs0, sp);
					} catch (IOException e) {
	...
	private void cmdWorld(List<String> args) {
		...
		for (int i = 1; i < args.size(); i++) {
			...
			switch (args.get(i).toLowerCase()) {
			case HELP -> {
				this.c.writeLines(Messages.format(WORLD_HELP_BLA_BLA_MNY_ARGS, CMD_WORLD, HELP, argLoadAll, argLoad, argCreate, argPrint, argPrintResources, argTile,
					argToBuild, argSave, argSaveForce, argSaveAll, argSaveAllForce, argBuild, argTileType, argTileResource, argFillRandom, argFillTotallyRandom,
					argFillTotallyRandom));
			}
			case argLoadAll -> {
				if (++i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argLoadAll));
					return;
				}
				...
				try (InputStream in = Files.newInputStream(p); Connection conn = Connection.OneWayAccept.acceptReadOnly(in, this.usr)) {
					...
					this.c.writeLines(Messages.format(WORLD_LOAD_ERROR_ON_LOAD, e));
				}
			}
			case argLoad -> {
				if (++i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argLoad));
					return;
				}
				Path p = Path.of(args.get(i));
				if (!Files.exists(p)) {
			...
			case argCreate -> {
				...
				i += 2;
				if (i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argCreate));
					return;
				}
				int xlen;
				int ylen;
				try {
					...
					this.c.writeLines(Messages.format(WORLD_CREATE_COULD_NOT_PARSE_THE_WORLD_SIZE, args.get(i - 1), args.get(i), nfe));
					return;
				}
				if (this.world instanceof RemoteWorld rw) {
					try {
						...
						this.c.writeLines(Messages.format(WORLD_CREATE_ERROR_CLOSING_REMOTE_WORLD, e));
					}
				}
				this.world = null;
				Thread st = this.serverThread;
			...
			case argTile -> {
				i += 2;
				if (i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argTile));
					return;
				}
				if (this.world == null) {
				...
				if (x < 0 || x >= this.world.xlen() || y < 0 || y >= this.world.ylen()) {
					this.c.writeLines(Messages.format(COORDINATE_IS_OUT_OF_BOUNDS_XLEN_0_YLEN_1_X_2_Y_3, Integer.toString(this.world.xlen()),
			...
			case argSaveAll, argSaveAllForce -> {
				if (++i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, args.get(i - 1)));
					return;
				}
				if (this.world == null) {
			...
			case argSave, argSaveForce -> {
				...
				try (OutputStream out = Files.newOutputStream(p); Connection conn = Connection.OneWayAccept.acceptWriteOnly(out, this.usr)) {
					...
					this.c.writeLines(Messages.format(WORLD_SAVE__ALL_ERROR_ON_SAVE, e));
				}
			}
			case argBuild -> {
				if (this.world == null) {
				...
				try {
					...
					this.c.writeLines(Messages.format(WORLD_BUILD_ERROR_ON_BUILD, e));
				}
			}
			case argTileType -> {
				i += 3;
				if (i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argTileType));
					return;
				}
				if (this.world == null) {
				...
				case normalSuffix -> {
					...
					if (old == null || old.ground == null || old.ground == GroundType.NOT_EXPLORED) {
						this.c.writeLines(Messages.format(WORLD_TILE_TYPE_NOT_ACCEPT_SUFFIX, old == null ? GroundType.NOT_EXPLORED : old.ground, normalSuffix));
						yield null;
					}
				...
				case deepSuffix -> {
					...
					if (old == null || old.ground == null || !old.ground.isWater()) {
						this.c.writeLines(Messages.format(WORLD_TILE_TYPE_NOT_ACCEPT_SUFFIX, old == null ? GroundType.NOT_EXPLORED : old.ground, deepSuffix));
						yield null;
					}
				...
				case hillSuffix -> {
					...
					if (old == null || old.ground == null || !old.ground.isHill() && !old.ground.isFlat()) {
						this.c.writeLines(Messages.format(WORLD_TILE_TYPE_NOT_ACCEPT_SUFFIX, old == null ? GroundType.NOT_EXPLORED : old.ground, hillSuffix));
						yield null;
					}
					yield old.ground.addHill(false, true);
				}
				default -> {
					this.c.writeLines(Messages.format(WORLD_TILE_TYPE_UNKNOWN_GROUND, args.get(i - 2)));
					yield null;
				}
				};
				if (type != null) {
			...
			case argTileResource -> {
				i += 3;
				if (i >= args.size()) {
					this.c.writeLines(Messages.format(NOT_ENUGH_ARGUMENTS_FOR_THE_0_ARG, argTileResource));
					return;
				}
				if (this.world == null) {
					this.c.writeLines(WORLD_MODIFY_MISSING_WORLD);
				...
				default -> {
					this.c.writeLines(Messages.format(WORLD_TILE_RESOURCE_UNKNOWN_RESOURCE, args.get(i - 2)));
					yield null;
				}
				};
				if (res != null) {
	...
	private void writeTile(int x, int y) {
		...
		this.c.writeLines(Messages.format(WORLD_TILE_X_0_Y_1_GROUND_2_RESOURCE_3, Integer.toString(x), Integer.toString(y), tile.ground, tile.resource));
	}
	...
	private void cmdWorldInteractiveLoad() {
		...
		do {
			...
			if (!Files.exists(p)) {
				this.c.writeLines(Messages.format(WORLD_LOAD_THE_FILE_0_DOES_NOT_EXIST, p));
				continue;
			}
			if (!Files.isRegularFile(p)) {
				this.c.writeLines(Messages.format(WORLD_LOAD_THE_PATH_0_DOES_NOT_A_FILE, p));
				continue;
			}
			rootLogin(askPW);
			try (InputStream in = Files.newInputStream(p); Connection conn = Connection.OneWayAccept.acceptReadOnly(in, this.usr)) {
	...
	private void cmdWorldAllTilesResources() {
		...
		this.c.writeLines(Messages.format(WORLD_PRINT_RESOURCES_LEGEND, "G", "I", "C")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		int xlen = this.world.xlen();
		int ylen = this.world.ylen();
		this.c.writeLines(Messages.format(WORLD_PRINT_SIZES, Integer.toString(xlen), Integer.toString(ylen)));
		for (int y = 0; y < ylen; y++) {
			...
			for (int x = 0; x < xlen; x++) {
				...
				default -> throw new AssertionError(Messages.format(UNKNOWN_TILE_RESOURCE_0, t.resource.name()));
				});
			}
	...
	private void cmdWorldAllTilesType() {
		...
		this.c.writeLines(Messages.format(WORLD_PRINT_GROUNDS_LEGEND, "#", "w", "W", "b", "B", "g", "G", "f", "F", "s", "S", "m")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$ //$NON-NLS-10$ //$NON-NLS-11$ //$NON-NLS-12$
		int xlen = this.world.xlen();
		int ylen = this.world.ylen();
		this.c.writeLines(Messages.format(WORLD_PRINT_SIZES, Integer.toString(xlen), Integer.toString(ylen)));
		for (int y = 0; y < ylen; y++) {
			...
			for (int x = 0; x < xlen; x++) {
				...
				case SWAMP_HILL -> 'S';
				case MOUNTAIN -> 'm';
				default -> throw new AssertionError(Messages.format(UNKNOWN_GROUND_TYPE_0, t.ground.name()));
				});
			}
			this.c.writeLines(b.toString());
		}
	...
	private void cmdUsername(List<String> args) {
		...
		for (int i = 1; i < args.size(); i++) {
			...
			switch (args.get(i).toLowerCase()) {
			case HELP -> {
				this.c.writeLines(Messages.format(USERNAME_HELP_CMD_0_HELP_1_SET_2_GET_3, CMD_USERNAME, HELP, argSet, argGet));
			}
			case argSet -> {
				i++;
				if (i >= args.size()) {
	...
	private void cmdUsernameNoArgs() {
		String cur = this.usr == null ? this.username : this.usr.name();
		if (cur != null) {
			this.c.writeLines(Messages.format(USERNAME_CURRENT_USERNAME, cur));
		}
	...
	private void cmdStatus(List<String> args) {
		if (args.size() == 1) {
			...
			for (int i = 1; i < args.size(); i++) {
				...
				case HELP -> {
					this.c.writeLines(
						Messages.format(STATUS_HELP_BLA_BLA, HELP, argUser, argWorldRemoteAll, argWorldRemoteWorld, argServer, argServerpw, argServerPW));
				}
	...
	private void cmdStatusServer() {
		if (this.serverThread != null) {
			Map<User, Connection> cs = this.connects;
			this.c.writeLines(Messages.format(STATUS_SERVER_RUNNING, cs == null ? STATUS_SERVER_NO_CONNECTS : Integer.toString(cs.size())));
		} else {
	...
	private void cmdStatusWorldRemoteAll() {
		...
		try {
			...
			this.c.writeLines(Messages.format(STATUS_BOUNDS_XLEN_0_YLEN_1, Integer.toString(this.world.xlen()), Integer.toString(this.world.ylen())));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	private void cmdStatusWorld() {
		...
		if (this.world == null) {
			...
			this.c.writeLines(Messages.format(STATUS_WORLD_UNKNOWN_TYPE_0, this.world.getClass()));
		}
		if (writeBounds) {
			this.c.writeLines(Messages.format(STATUS_BOUNDS_XLEN_0_YLEN_1, Integer.toString(this.world.xlen()), Integer.toString(this.world.ylen())));
		}
	...
	private void cmdStatusUser() {
		if (this.usr == null) {
			this.c.writeLines(Messages.format(STATUS_USER_NOT_LOGGED_IN_USERNAME_0, this.username == null ? RootUser.ROOT_NAME : this.username));
		} else {
			this.c.writeLines(Messages.format(STATUS_USER_NAME_0, this.usr.name()));
		}
	}
	
	private void cmdVersion(List<String> args) {
		if (args.size() == 1) {
			this.c.writeLines(Messages.format(VERSION_SQUARE_CONQUERER_VERSION_0, Settings.VERSION_STRING));
		} else if (args.size() == 2 && HELP.equalsIgnoreCase(args.get(1))) {
			this.c.writeLines(Messages.format(VERSION_HELP_0_BLA_BLA, HELP));
		} else {
			this.c.writeLines(Messages.format(UNKNOWN_ARGUMENT_0, args.get(2)));
		}
	}
	...
	private void cmdHelp(List<String> args) {
		switch (args.size()) {
		case 1 -> {
			this.c.writeLines(Messages.format(HELP_GENERAL_MESSAGE, Settings.VERSION_STRING, CMD_HELP, CMD_VERSION, CMD_STATUS, CMD_USERNAME, CMD_WORLD, CMD_SERVER,
				CMD_SETPW, CMD_SERVERPW, CMD_QUIT, CMD_EXIT, CMD_QUIT, HELP, CMD_HELP));
		}
		case 2 -> {
	...
	private void doTasks() throws AssertionError {
		while (!this.tasks.isEmpty()) {
			...
			try {
				...
				System.err.println(Messages.format(ERROR_WHILE_EXECUTING_TASK_0, e));
			}
		}
	}
		...
		do {
			...
			do {
				...
				if (!Files.exists(loadFile)) {
					this.c.writeLines(Messages.format(WORLD_LOAD_THE_FILE_0_DOES_NOT_EXIST, loadFile));
					continue;
				}
				if (!Files.isRegularFile(loadFile)) {
					this.c.writeLines(Messages.format(WORLD_LOAD_THE_PATH_0_DOES_NOT_A_FILE, loadFile));
					continue;
				}
				break;
			} while (retry(true));
	...
	private void doTaskLoadFile(Path loadFile) {
		...
		do {
			if (askUsr) {
				this.c.writeLines(Messages.format(LOAD_TASK_LOAD_NOW_THE_FILE_0, loadFile));
				char[] pw = this.c.readPassword(SET_PW_PROMPT_ENTER_YOUR_PASSWORD);
	...
	private int readNumber(String prompt, int min, int max) {
		...
		do {
			...
			try {
				...
				this.c.writeLines(Messages.format(READN_NUM_COULD_NOT_PARSE_THE_NUMBER_0_1, line, e.toString()));
			}
		} while (retry(val < min || val > max, Messages.format(READN_NUM_THE_MINIMUM_NUMBER_IS_0_1, Integer.toString(min),
			(max != Integer.MAX_VALUE ? Messages.format(READN_NUM_AND_THE_MAXIMUM_NUMBER_IS, Integer.toString(max)) : "")))); //$NON-NLS-1$
		return val;
	}
